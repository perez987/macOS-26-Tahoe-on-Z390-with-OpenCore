...
Both config.plists work for the following configurations thanks to the MinKernel and MaxKernel properties of the kexts:
...
So the same EFI works for me to boot from Ventura to Tahoe. Modify it according to your hardware and needs.
